...
-- когда и заказчик и сотрудник зарегистрированы в городе London, а
...
WHERE EXISTS (SELECT 1 FROM order_details WHERE products.product_id = order_details.product_id AND public.order_details.quantity = 10);
